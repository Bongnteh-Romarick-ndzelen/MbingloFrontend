    ...
    const contentVariations = [
        {
            ...
            button2: "Learn More",
            image: "/src/assets/Player-removebg-preview.png"
        },
        {
            ...
            image: "/src/assets/player-celebrating.png"
        }
    ];
    ...
    return (
        <>
            <section className="relative bg-gradient-to-br from-green-900 via-black to-black text-white min-h-[80vh] flex items-center overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-green-900/30 to-black/60"></div>
                        ...
                        <AnimatePresence mode='wait'>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <motion.div
                                        className="relative overflow-hidden rounded-xl border-4 border-white shadow-xl"
                                        style={{
                                    ...
                                    {currentContent === 0 && (
                                        <>
                                            <motion.div
                                                className="absolute -bottom-6 -left-6 w-16 h-16 bg-green-600 rounded-full shadow-lg"
                                                initial={{ scale: 0 }}
                                                animate={{ scale: 1 }}
                                                transition={{ delay: 0.6 }}
                                            />
                                            <motion.div
                                                className="absolute -top-6 -right-6 w-12 h-12 bg-green-800 rounded-full shadow-lg"
                                                initial={{ scale: 0 }}
                                                animate={{ scale: 1 }}
                                ...
                                {currentContent === 1 && (
                                    <motion.img
                                        src="/src/assets/Player-removebg-preview.png"
                                        alt="Football"
